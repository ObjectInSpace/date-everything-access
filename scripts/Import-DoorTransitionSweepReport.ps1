...
Write-Warning "Import-DoorTransitionSweepReport.ps1 is a legacy artifact-import helper. For normal blocker triage, use .\scripts\Invoke-LiveNavigationAudit.ps1."
